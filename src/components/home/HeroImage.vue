<template>
  <div id="hero" class="hero">
    <div class=" text">
      <div class="wraping">
        <div class="logo">
          <img id="gambar" src="@/assets/icons/logo/kopi-sore.svg" alt="Kopi Sore">
        </div>
...
<script>
import { createObserver } from '@/assets/js/transition.js';
...
.hero {
  ...
  background-image: url("@/assets/imgs/kopisore11.webp");
